...
from tld.configs import ModelConfig, DataConfig, TrainConfig, Denoiser1DConfig
...
config = ModelConfig(
        ...
        denoiser_config=Denoiser1DConfig(),
    )
...
if True: #not os.path.exists(dataconfig.lr_latent_path):
    ...
    for x, y, z in tqdm(train_loader):
        ...
        if config.use_tatitok:
            ...
            pooled_embed = text_global_pool(text_guidance, idxs, clip_encoder.text_pool_type)
